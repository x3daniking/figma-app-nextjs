...
const RectangleBarTablet = () => {

    return (
        <section name="Rectangle Bar for Tablet and Larger" className="hidden">
            <div
                className="bg-white rounded-md absolute top-[33.875rem] md:top-[36rem] lg:top-[39.625rem] xl:top-[46.125rem] xl:l-[2.625rem] xl:pr-12 left-0 right-0 w-fit mx-auto px-4 flex items-center justify-center shadow-md">
                <ul className="flex items-center justify-center text-gray-700">
                    ...
                    <li><input className="w-40 text-xs focus:outline-none md:w-auto xl:text-base" type="text"
                        placeholder="Enter Your Location Here!" />
                    </li>
                    <li className="h-20 lg:h-24 xl:h-28 w-0.5 bg-gray-300"></li>
                    <li className="px-4 md:px-6 lg:px-8 xl:px-4 xl:mx-9">
                        <select
                            className="focus:outline-none bg-transparent hover:cursor-pointer text-sm lg:text-base font-normal"
                    ...
                    <li className="px-4 md:px-6 lg:px-8 xl:px-4 xl:mx-9">
                        <select
                            className="focus:outline-none bg-transparent hover:cursor-pointer text-sm lg:text-base xl:text-lg font-normal"
                            name="Category" id="Category">
...
export default RectangleBarTablet